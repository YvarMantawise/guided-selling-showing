    ...
    <div>
      <div className="text-center mb-8">
        ...
        <p className="text-berino-gray">
          Op basis van je gesprek hebben we deze producten voor je geselecteerd.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <a
                ...
                className="block relative aspect-square bg-berino-offwhite overflow-hidden"
              >
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  {isAvailable && addToCartUrl ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-berino-forest text-white text-sm font-semibold rounded-xl hover:bg-berino-sage transition-colors"
                    >
